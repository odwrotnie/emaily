...
object EmailyService  {
  val TOPIC_NAME = "greetings"
}

/**
  * The Emaily service interface.
  * <p>
  * This describes everything that Lagom needs to know about how to serve and
  * consume the EmailyService.
  */
trait EmailyService extends Service {
  ...
  override final def descriptor = {
    ...
    named("emaily")
      ...
      .withTopics(
        topic(EmailyService.TOPIC_NAME, greetingsTopic)
